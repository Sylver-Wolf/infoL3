 ...
 */
class getIncroyableBobRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IncroyableBobRepository' shared autowired service.
     *
     * @return \App\Repository\IncroyableBobRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IncroyableBobRepository.php';

        return $container->privates['App\\Repository\\IncroyableBobRepository'] = new \App\Repository\IncroyableBobRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
